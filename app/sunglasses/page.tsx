  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-8 border-b border-cyan-500/20 pb-4">
        <div>
          <h1 className="text-3xl font-black text-white flex items-center gap-2">🕶 Sunglasses</h1>
          <p className="text-slate-400 text-sm mt-1">প্রিমিয়াম সানগ্লাস কালেকশন</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-slate-400">কোনো সানগ্লাস পাওয়া যায়নি।</div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {products.map((item) => (
            <div key={item.id} className="glass-panel p-4 rounded-2xl border border-cyan-500/20 text-center hover:border-cyan-400 transition flex flex-col justify-between">
              <div>
                {/* ছবি কন্টেইনার - ক্লিক করলে ফুল-স্ক্রিন জুম হবে */}
                <div 
