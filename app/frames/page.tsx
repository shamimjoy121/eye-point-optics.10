  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-8 border-b border-cyan-500/20 pb-4">
        <div>
          <h1 className="text-3xl font-black text-white flex items-center gap-2">👓 Eyeglasses Frames</h1>
          <p className="text-slate-400 text-sm mt-1">প্রিমিয়াম চশমার ফ্রেম কালেকশন</p>
        </div>
