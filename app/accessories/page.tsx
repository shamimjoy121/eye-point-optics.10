  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-8 border-b border-cyan-500/20 pb-4">
        <div>
          <h1 className="text-3xl font-black text-white flex items-center gap-2">📁 Accessories</h1>
          <p className="text-slate-400 text-sm mt-1">চশমার প্রয়োজনীয় আনুষঙ্গিক এক্সেসরিজ</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-slate-400">কোনো এক্সেসরিজ পাওয়া যায়নি।</div>
      ) : (
