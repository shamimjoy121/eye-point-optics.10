...
export default function Navbar() {
  return (
    <nav className="bg-slate-900/80 backdrop-blur-md border-b border-cyan-500/20 py-2.5 sticky top-[73px] z-40">
      {/* Container with horizontal scroll for mobile and proper alignment for desktop */}
      <div className="max-w-7xl mx-auto px-4 overflow-x-auto whitespace-nowrap scrollbar-none">
        <div className="flex items-center justify-start md:justify-center gap-3 text-sm md:text-base font-semibold text-slate-200 min-w-max">
